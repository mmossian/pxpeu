...
<section class="main-boxes g-pt-80 g-pb-20">
        <div class="container">
          <div class="row">
                ...
                <div class="g-pl-15--lg">
                  ...
                  <ul class="list-unstyled mb-0 g-font-size-18">
                    <li class="py-1">
                      ...
                      <strong>Helbidea:</strong> <?= $centro->direccion_simple ?>
                    </li>
                    <li class="py-1">
                      <i class="g-color-primary g-font-size-10 mr-2 fa fa-circle"></i>
                      <strong>Udalerria:</strong> <?= $centro->localidad ?>
                    </li>
                    <li class="py-1">
                      <i class="g-color-primary g-font-size-10 mr-2 fa fa-circle"></i>
                      <strong>Lurralde-historikoa:</strong> <?= $centro->provincia ?>
                    </li>
                    <li class="py-1">
                      <i class="g-color-primary g-font-size-10 mr-2 fa fa-circle"></i>
                      <strong>Tel.:</strong> <?= $centro->telefono1 ?> <?= is_null($centro->telefono2) ? '' :  ' - '.$centro->telefono2?>
                    </li>
                   <!--  <li class="py-1">
                      <i class="g-color-primary g-font-size-10 mr-2 fa fa-circle"></i>
                      <strong>Fax:</strong>
                    ...
                    <li class="py-1">
                      <i class="g-color-primary g-font-size-10 mr-2 fa fa-circle"></i>
                      <strong>Posta:</strong> <a class="g-color-primary" href="mailto:<?= $centro->email ?>"><?= $centro->email ?></a>
                    </li>
                </ul>
                </div>
              </div>
            ...
            <h3 class="g-font-weight-100 g-font-size-24 g-line-height-1_2 g-mb-30 ">Zentroak onartzen dituen ordainketa-moduak</h3>
      ...
      <div class="row">
          <div class="col-lg-6 g-mb-30  g-py-20">
            ...
            <div class="text-center">
              ...
              <h3 class="h5 g-color-black mb-0">Banku bidezko ordainketa</h3>
              <p class="g-mb-0 g-color-green g-font-weight-500 text-uppercase"><?= $centro->pagobanco == 1 ? 'Onartzen da' : 'Ez da onartzen' ?></p>
            </div>
            <!-- End Icon Blocks -->
          </div>
           ...
           <div class="col-lg-6 g-mb-30 g-brd-x g-brd-secondary-light-v2 g-py-20">
              ...
              <div class="text-center">
                ...
                <h3 class="h5 g-color-black mb-0">Kreditu-txartela</h3>
                <p class="g-mb-0 <?=  $centro->pagotarjeta == 1 ? 'g-color-green' : 'g-color-red' ?> g-font-weight-500 text-uppercase"><?= $centro->pagotarjeta == 1 ? 'Onartzen da' : 'Ez da onartzen' ?></p>
              </div>
              <!-- End Icon Blocks -->
          </div>
      <!--
      ...
      <small>* Ez da American Express txartelik onartzen</small>
            ...
            <div class="g-py-60">
              ...
              <ul class="nav justify-content-center u-nav-v1-1 u-nav-primary u-nav-rounded-3 g-mb-20" role="tablist" data-target="nav-1-1-primary-hor-center" data-tabs-mobile-type="slide-up-down" data-btn-classes="btn btn-md btn-block u-btn-outline-primary g-mb-20">
                <li class="nav-item">
                  <a class="nav-link active g-font-size-18" data-toggle="tab" href="#nav-1-1-primary-hor-center--1" role="tab">Hurrengo ikastaroak </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link g-font-size-18" data-toggle="tab" href="#nav-1-1-primary-hor-center--2" role="tab">Kokapena </a>
                </li>
              </ul>
              <!-- End Nav tabs -->
              <!-- Tab panes -->
                      ...
                      <tbody>
                        <?php foreach($cursos as $k => $c): ?>
                          ...
                          <tr class="row-curso-<?php echo $k ?>">
                            <td data-title="<?php echo $dataTitle[$indexData] ?>">
                            ...
                            <td data-title="<?php echo $dataTitle[++$indexData] ?>"><?php echo $this->lang->line($c->curso) ?></td>
                            <td data-title="<?php echo $dataTitle[++$indexData] ?>"><?= $c->idioma ?></td>
                            <td data-title="<?php echo $dataTitle[++$indexData] ?>"><?= $c->precio ?> €</td>
                           <!--  <td>
                          ...
                          <tr class="row-curso-<?php echo $k ?>">
                            <td colspan="5" class="buttons-table text-right border border-top-0 border-right-0 border-left-0 border-secondary">
                              <a href="<?php echo $this->init->baseUrl ?>index.php/preinscripcion/index/<?php echo $c->id_centro ?>/<?php echo $c->id_calendario ?>" class="btn btn-sm  g-bg-bluehight g-color-white g-color-white--hover g-color-primary--hover g-font-size-13">Aurreinskripzioa</a>
                            </td>
                          </tr>
                        <?php endforeach ?>
                      </tbody>
