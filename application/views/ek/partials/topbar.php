  ...
  <section class="grey-top">
    <div class="container g-py-10">
          <div class="enlace-dep">
              <a href="https://www.trafikoa.eus/wps/portal/trafico/!ut/p/z1/04_Sj9CPykssy0xPLMnMz0vMAfIjo8ziXTycTI2CzdwsLU2cvVwNXEIMjA0gQD-ckIIooLQBDuAI0h-lD1Th7-MZZhpo7OjuaBJoaubs42VpADdAH78JUWArTJy8jEJDfcNcHE1MTEMMfQI94Qb4eeTnpuoHp5YCLSvIjTDIDMgqBwC72gCN/dz/d5/L3dHQSEvUUtRZy9nQSEh/" target="_blank">
                <img src="<?= $this->init->baseUrl ?>assets-vial/img/logo/gobierno-vasco.png" alt="Eusko Jaurlaritza - Gobierno Vasco"/>
                <span>Segurtasun Saila</span>
              </a>
          </div>
    </div>
  </section>
  ...
  <div class="container g-py-5 text-right">
    ...
    <!-- Links -->
      ...
      <li class="list-inline-item  d-lg-inline-block u-link-v5 g-px-5 g-py-15 it-lang">
        <a class="g-color-white g-font-size-14" href="<?= $this->init->baseUrl ?>index.php/idioma/index/ek/<?= $segment ?>">EU</a>
      </li>
      ...
      <li class="list-inline-item  d-lg-inline-block u-link-v5 g-px-5 g-py-15">
       <a class="g-color-white g-link-underline g-font-size-14" href="<?= $this->init->baseUrl ?>index.php/idioma/index/es/<?= $segment ?>">ES</a>
      </li>
    <!-- End Links -->
    </ul>
  </div>
