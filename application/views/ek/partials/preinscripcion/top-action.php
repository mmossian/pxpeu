        ...
        <div class="row">
          ...
          <div class="col-md-8">
		         ...
		         <ul class="unstyled-list">
						...
						<li><b>Tipo:</b> <?php echo $this->lang->line($curso->curso) ?></li>
						<li><b>Idioma:</b> <?php echo $curso->idioma ?></li>
						<li><b>Centro:</b> <?php echo $curso->nombre ?></li>
						<li><b>Dirección:</b> <?php echo $curso->direccion ?></li>
						<li><b><?php echo $this->lang->line('precio_sin_iva') ?>:</b> <?php echo $curso->precio ?> €</li>
					</ul>
              ...
              <form method="post" action="<?= $this->init->baseUrl ?>index.php/formulariopreinscripcion">
	              ...
	              <div class="g-mb-30">
	                <div class="g-mb-30">
	                  ...
	                  value="<?php echo isset($_SESSION['DISTINTIVA-REQUEST']) ? $_SESSION['DISTINTIVA-REQUEST']['pre_nombre'] : '' ?>">
	                </div>
	                <div class="g-mb-30">
	                  ...
	                  value="<?php echo isset($_SESSION['DISTINTIVA-REQUEST']) ? $_SESSION['DISTINTIVA-REQUEST']['pre_apellidos'] : '' ?>">
	                </div>
	                <div class="g-mb-30">
	                  ...
	                  value="<?php echo isset($_SESSION['DISTINTIVA-REQUEST']) ? $_SESSION['DISTINTIVA-REQUEST']['pre_telefono'] : '' ?>">
	                </div>
	                <div class="g-mb-30">
	                    ...
	                    value="<?php echo isset($_SESSION['DISTINTIVA-REQUEST']) ? $_SESSION['DISTINTIVA-REQUEST']['pre_dni'] : '' ?>">
	                </div>
	                <div class="g-mb-30">
	                    ...
	                    <select id="idioma-preferencia" class="js-custom-select w-100 u-select-v2 u-shadow-v19 g-color-text-light-v1 g-color-primary--hover g-bg-white text-left g-rounded-5 g-pl-30 g-py-12"
	                            ...
	                            name="pre_idioma">
	                    <option class="g-brd-secondary-light-v2 g-color-text-light-v1 g-color-white--active g-bg-primary--active" value="Espa&ntilde;ol" <?php echo (isset($_SESSION['DISTINTIVA-REQUEST']) AND $_SESSION['DISTINTIVA-REQUEST']['pre_idioma'] === 'Espa&ntilde;ol') ? 'selected="selected"' : ''?> >
	                    	Español
	                	</option>
	                    <option class="g-brd-secondary-light-v2 g-color-text-light-v1 g-color-white--active g-bg-primary--active" value="Euskera" <?php echo (isset($_SESSION['DISTINTIVA-REQUEST']) AND $_SESSION['DISTINTIVA-REQUEST']['pre_idioma'] === 'Euskera') ? 'selected="selected"' : ''?>>
	                    	Euskera
	                    </option>
	                  </select>
	                </div>
