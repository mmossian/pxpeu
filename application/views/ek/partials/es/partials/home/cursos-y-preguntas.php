...
<section class="g-py-0">
        <div class="container">
          <div class="row">
			<div class="col-lg-6">
			  <h3 class="g-font-size-40 g-font-weight-400 g-mb-50">Precio de Cursos año 2019</h3>
			  <div class="row">
			    <div class="col-md-3">
			      <span class="g-elipse">
			    ...
			    <div class="col-md-9">
			      <ul class="list-unstyled g-pl-10">
			        ...
			        <li class="g-font-size-22 g-font-weight-700 g-mt-10 g-color-bluehight">180,92 € + IVA</li>
			      </ul>
			    </div>
			  </div>
			  <div class="row g-mt-20">
			    ...
			    <div class="col-md-9">
			      <ul class="list-unstyled g-pl-10">
			        <li class="g-font-size-26 g-pt-5 g-font-weight-700">Curso recuperación permiso</li>
			        <li class="g-font-size-18 g-mt-minus-5">(Si has perdido el permiso)</li>
			        <li class="g-font-size-22 g-font-weight-700 g-mt-10 g-color-bluehight">340,59 € + IVA</li>
			      </ul>
			    </div>
			  </div>
